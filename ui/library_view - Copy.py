...
class LibraryView(ctk.CTkFrame):
    def __init__(self, master, app_router, console_id, console_name):
        ...
        self.empty_cover = ctk.CTkImage(light_image=Image.new("RGBA", (480, 360), (0, 0, 0, 0)), size=(480, 360))
    ...
    def setup_details_panel(self, parent_frame):
        ...
        # 1. Cover Image (ขยายขนาดเป็น 480x360)
        self.lbl_cover = ctk.CTkLabel(top_wrapper, text="", width=480, height=360, fg_color="#1a1a1a", corner_radius=10)
    ...
    def on_game_selected(self, rom, selected_btn):
        ...
        if cover_path and os.path.exists(cover_path):
            try:
                ...
                # ขยายเป็น 480x360 รับกับหน้าจอ 
                pil_img = ImageOps.contain(pil_img, (480, 360), Image.Resampling.LANCZOS)
